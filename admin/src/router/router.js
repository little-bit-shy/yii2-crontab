...
export const appRouter = () => {
    return [
        ...
        },
        {
            ...
            children: [
                {
                    access: access(['/v1/auth-item/project-directory', '/v1/auth-item/all-lists']),
                ...
                {
                    access: access(['/v1/auth-item/index']),
                ...
                {
                    access: access(['/v1/auth-item/user-lists']),
                    path: 'manage-users',
                    title: '管理用户',
        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    path: 'execute-task-list',
                    title: '任务列表',
                    name: 'execute-task-list',
                    component: resolve => {
                        require(['@/views/execute-task/index.vue'], resolve);
                    }
                }
            ]
        },
