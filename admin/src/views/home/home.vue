    ...
    <div class="home-main">
        <Row :gutter="10">
            ...
            <Row class-name="home-page-row1" :gutter="10">
                <Col :xs="24" :sm="12" :md="12" :lg="24" :style="{marginBottom: '10px'}">
                <Card>
                    ...
                    <Row class="margin-top-8">
                        <Col span="8">
                        <p class="notwrap">最近登录时间:</p></Col>
                        <Col span="16" class="padding-left-8">
                        {{ user.last_login_at }}</Col>
                    </Row>
                    <Row class="margin-top-8">
                        <Col span="8">
                        <p class="notwrap">最近登录IP:</p></Col>
                        <Col span="16" class="padding-left-8">
                        {{ user.last_login_ip }}</Col>
                    </Row>
                </Card>
                </Col>
                <Col :xs="24" :sm="12" :md="12" :lg="24" :style="{marginBottom: '10px'}">
    ...
    export default {
        ...
        computed: {
            ...
            user () {
                ...
                // user.last_login_at = util.formatDate(new Date(user.last_login_at), 'yyyy-MM-dd hh:mm');
                return user;
            }
        },
        methods: {
